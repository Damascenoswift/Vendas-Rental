...
import { AlertTriangle, CalendarClock, CirclePlay, RefreshCw, UserCheck, Users } from "lucide-react"

import type { TaskPersonalSummaryTask, TaskPersonalWeeklySummary } from "@/services/task-personal-weekly-service"
...
export function TaskMyWeekDashboard({ summary }: TaskMyWeekDashboardProps) {
